...
if(lastVal!=(val!=last)){digitalWrite(HOT_PWR_LED_out,val!=last);
#ifdef ATTACH_INTERRUPT
Serial.print("count ");Serial.println(count);
Serial.print("last ");Serial.println(last);
Serial.print("lastVal ");Serial.println(lastVal);
...
void ShowMENU(){
  LC.setChar(0,7,ar1,LD1);
  LC.setChar(0,6,ar2,LD2);
  LC.setChar(0,5,ar3,LD3);
  LC.setChar(0,4,ar4,LD4);
  LC.setChar(0,3,ar5,LD5);
  LC.setChar(0,2,ar6,LD6);
  LC.setChar(0,1,ar7,LD7);
  LC.setChar(0,0,ar8,LD8);}
...
ar1=1;
ar7=StepValue/10%10;if(ar7==0){ar7=' ';}
ar8=StepValue%10;break;
case 1: trig1=DownTime;
ar1=2;
ar7=DownTime/10%10;if(ar7==0){ar7=' ';}
ar8=DownTime%10;break;
case 2: trig1=WaitAutoRet;
ar1=3;
ar7=WaitAutoRet/10%10;if(ar7==0){ar7=' ';}
ar8=WaitAutoRet%10;break;
case 3: trig1=KpSet;
ar1=4;
ar6=KpSet/100%10;LD6=true;
ar7=KpSet/10%10;
ar8=KpSet%10;break;
case 4: trig1=KiSet;
ar1=5;
ar6=KiSet/100%10;LD6=true;
ar7=KiSet/10%10;
ar8=KiSet%10;break;
case 5: trig1=KdSet;
ar1=6;
ar6=KdSet/100%10;LD6=true;
ar7=KdSet/10%10;
ar8=KdSet%10;break;
case 6: trig1=LED_Bright;
ar1=7;
ar7=LED_Bright/10%10;if(ar7==0){ar7=' ';}
ar8=LED_Bright%10;break;}}
